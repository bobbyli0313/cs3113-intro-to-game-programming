...
Entity::Entity(Vector2 position, Vector2 scale, const char *textureFilepath, 
    ...
    mAngle {0.0f}, mEntityType {entityType}, mLives {3} { }
...
Entity::Entity(Vector2 position, Vector2 scale, const char *textureFilepath, 
        ...
        mSpeed { DEFAULT_SPEED }, mEntityType {entityType}, mLives{3} { }
...
void Entity::AIWander() {
    if (mPosition.x <= 400.0f) moveRight();
    else if (mPosition.x >= 550.0f) moveLeft();
}
...
void Entity::AITeleport() {
    if (mPosition.x == 835.0f && mTeleportTimer <= 0) {
        mPosition.x = 985.0f;
        mPosition.y = 350.0f;
        mTeleportTimer = 5.0f;
    } else if (mPosition.x == 985.0f && mTeleportTimer <= 0) {
        mPosition.x = 835.0f;
        mPosition.y = 200.0f;
        mTeleportTimer = 5.0f;
    }
