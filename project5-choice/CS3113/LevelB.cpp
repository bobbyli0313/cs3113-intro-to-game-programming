...
void LevelB::initialise()
{
   ...
   mGameState.ai = new Entity(
      {-550.0f, -750.0f},                       // position
      {150.0f, 150.0f},                         // scale
      "assets/mobB.png",                        // texture file address
      ATLAS,                                    // single image or atlas?
      { 4, 3 },                                 // atlas dimensions
   ...
   mGameState.question = "Is 1 a prime number?";
   mGameState.answerE = "e) Yes";
   mGameState.answerF = "f) No";
   mGameState.answerG = "g) IDK";
}
