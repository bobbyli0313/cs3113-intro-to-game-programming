...
enum EntityType   { PLAYER, CARROT, POTION, NPC, NONE };
enum AIType       { WANDERER, FOLLOWER, GHOST         };
enum AIState      { WALKING, IDLE, ENGAGE             };
...
public:
    ...
    int         getShaderStatus()          const { return mShaderStatus;          }
    ...
    void setLives(int newLives)
        { mLives = newLives;                       }
    void setShaderStatus(int newShaderStatus)
        { mShaderStatus = newShaderStatus;         }
};
