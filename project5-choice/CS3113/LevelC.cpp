...
void LevelC::initialise()
{
   ...
   mGameState.ai = new Entity(
      {60.0f, 750.0f},                       // position
      {150.0f, 150.0f},                         // scale
      "assets/mobC.png",                        // texture file address
      ATLAS,                                    // single image or atlas?
      { 4, 3 },                                 // atlas dimensions
   ...
   mGameState.question = "How many parameters does DrawPoly() take?";
   mGameState.answerE = "e) 5";
   mGameState.answerF = "f) 6";
   mGameState.answerG = "g) 7";
}
...
void LevelC::update(float deltaTime)
{
   ...
   if (mGameState.character->getPosition().y > 1850.0f) {
